import type { IOutgoingIntegration, Serialized, OutgoingIntegrationEvent } from '@rocket.chat/core-typings';
...
type EditOutgoingWebhookProps = { webhookData?: Serialized<IOutgoingIntegration> };
